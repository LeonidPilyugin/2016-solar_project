...
def parse_star_parameters(line, star):
    ...
    **star** — объект звезды.
    ...
    star.x = int(star_parameters[4])
    star.y = int(star_parameters[5])
    star.Vx = int(star_parameters[6])
    star.Vy = int(star_parameters[7])
...
def parse_planet_parameters(line, planet):
    ...
    **planet** — объект планеты.
    ...
    planet.x = int(planet_parameters[4])
    planet.y = int(planet_parameters[5])
    planet.Vx = int(planet_parameters[6])
    planet.Vy = int(planet_parameters[7])
